...
export default defineComponent({
  ...
  setup() {
    ...
    const updateUser = () => {
      ...
      // user.gender = "男"; //这种方式界面可以更新渲染，而且这个数据最终也加入到了目标对象里面
      ...
      // 通过当前代理对象，找到该对象的某个属性，更改该属性中的某个数据数据
      // user.wife.cars[1] = "保时捷";

      // 通过当前的代理对象把目标对象中的某个数组属性添加一个新的数据
      user.wife.cars[2] = "劳斯莱斯";
    };
    return {
      user,
      updateUser,
