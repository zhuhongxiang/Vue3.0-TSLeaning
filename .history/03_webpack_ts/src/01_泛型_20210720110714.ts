...
(() => {
    ...
    // arr1中存储的是数字类型的数据
    // arr2中存储的是字符串类的数据
    console.log(arr3[0].toFixed(2))// 没有任何的智能提示信息（要么有方法名字的提示信息，要么有错误的提示信息）
    console.log(arr4[0].split(''))// 没有任何的智能提示信息（要么有方法名字的提示信息，要么有错误的提示信息）
    ...
    // const arr5 = getArr3(100.123, 3)
    // const arr6 = getArr3('abc', 3)
    // console.log(arr5)
    // console.log(arr6)
    const arr5 = getArr4<number>(200.123, 5)
    const arr6 = getArr4<string>('abcd', 5)
    console.log(arr5)
    console.log(arr6)
